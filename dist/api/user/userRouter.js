...
var UserSchema = import_zod2.z.object({
  ...
  parentreferrerid: import_zod2.z.string(),
  affiliateamount: import_zod2.z.number(),
  subaffiliateamount: import_zod2.z.number(),
...
var CreateUserSchema = import_zod2.z.object({
  body: import_zod2.z.object({
    ...
    referrerID: import_zod2.z.string(),
    sig: import_zod2.z.string()
  })
});
var ClickUserSchema = import_zod2.z.object({
  body: import_zod2.z.object({
    id: import_zod2.z.string(),
...
var UserRepository = class {
  ...
  async findAllAsync() {
    try {
      const { rows } = await this.pool.query("SELECT * FROM tele_hunter where flag = 0 ORDER BY score DESC LIMIT 100 ");
      return rows;
    } catch (err) {
      console.log(err);
      return null;
